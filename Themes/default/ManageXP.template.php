...
function template_main()
{
    ...
    echo '
		...
		<p class="information">
Edit your Zealy XP function here.					</p>
		<div id="report_buttons">';

    echo '
		</div>';
    echo '<div class="cat_bar">
			<h3 class="catbg">Set Zealy XP Function Managers</h3>
		</div>
		<div class="windowbg">
		<dl class="settings">
                            <form method="post" action="', $context['pause_url'], '" >                                  
									<dt>
										<a id="setting_reg_verification"></a> <span><label for="reg_verification">Enable Zealy XP Function</label></span>
									</dt>
									<dd>
									Pause
...
<dl class="settings">
                            <form method="post" action="', $context['post_url'], '" >                                  
									...
									<dd>
										...
										Max<input type="number" name="max" id="max" value="', $context['max'], '">
									</dd>
				<input type="submit" value="Save" class="button">
									<input type="hidden" name="', $context['session_var'], '" value="', $context['session_id'], '">
				</form> 
								...
								<dl class="settings">
								  <form method="post" action="', $context['radio_url'], '" >    
									<dt>
										<a id="setting_reg_verification"></a> <span><label for="reg_verification">Exchange Ratio Zealy </label></span>
									</dt>
									<dd>
										XP : FLM = <input type="number" name="radio" id="radio" value="', $context['radio'], '"> : 1
									</dd>
