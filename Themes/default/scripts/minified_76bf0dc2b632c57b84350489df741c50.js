...
return '[youtube]'+youtube_id+'[/youtube]';else return content},html:'<div class="videocontainer"><div><iframe frameborder="0" src="https://www.youtube-nocookie.com/embed/{0}?wmode=opaque" data-youtube-id="{0}" loading="lazy" allowfullscreen></iframe></div></div>'});var pingTime=10000;var notificationIcon='/favicon.ico';$(function()
