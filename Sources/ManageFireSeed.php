...
function ManageFireSeed()
{
    ...
    loadTemplate('ManageFireSeed');

//    loadLanguage('Reports');
    $context['page_title'] = 'managefireseed';
    $context['post_url'] = $scripturl . '?action=admin;area=managefireseed;save=limit';
    $context['set_url'] = $scripturl . '?action=admin;area=managefireseed;save=set';
    $context['pause_url'] = $scripturl . '?action=admin;area=managefireseed;save=pause';
    $context['delete_url'] = $scripturl . '?action=admin;area=managefireseed';
    if (isset($_POST['work']) && $_POST['work'] == 'delete') {
        ...
        redirectexit('action=admin;area=managefireseed');
    }
